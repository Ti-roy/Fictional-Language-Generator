...
namespace LanguageGenerator.Core.SyntacticUnit.RootSU
{
    public class RootSU : IRootSU
    {
        ...
        public bool Equals(IRootSU other)
        {
            ...
            return Frequency == other.Frequency && Equals(Property, other.Property) && Equals(RootProperty, other.RootProperty) &&
                   string.Equals(StringRepresentation, other.StringRepresentation);
        }
