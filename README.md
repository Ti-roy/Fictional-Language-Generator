...
Hupalo fov.
```
Not bad, huh? In ~60 lines of code we created near infine amount of orcish senteces, which can be randomly generated at any time in your game or app. (Note: in output first latter is made uppercase by .net not engine related code, initially all letters where lowercase).
